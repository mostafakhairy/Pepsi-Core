...
ALTER TABLE [Users] ADD [Country] nvarchar(20) NULL DEFAULT N'SA';

GO

ALTER TABLE [Users] ADD [Language] nvarchar(10) NULL DEFAULT N'Arabic';

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200811140339_AddLanguageAndCountryToUser', N'3.1.5');
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Users]') AND [c].[name] = N'Country');
IF @var10 IS NOT NULL EXEC(N'ALTER TABLE [Users] DROP CONSTRAINT [' + @var10 + '];');
ALTER TABLE [Users] ALTER COLUMN [Country] nvarchar(20) NULL;
ALTER TABLE [Users] ADD DEFAULT N'Saudi Arabia' FOR [Country];

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200814003841_UpdateCountryDefaultValue', N'3.1.5');

GO

EXEC sp_rename N'[UserTransactions].[points]', N'Points', N'COLUMN';

GO

ALTER TABLE [UserTransactions] ADD [CategoryName] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200814005401_FixTransactionPointsName', N'3.1.5');

GO

ALTER TABLE [UserTransactions] ADD [RewardRedeemed] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200816103642_addRewardRedeemedToTransactions', N'3.1.5');
